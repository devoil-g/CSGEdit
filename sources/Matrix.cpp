...
Math::Matrix<4, 4>    Math::Matrix<4, 4>::inverse() const
{
  ...
  matrix._matrix[0][0] = (+this->_matrix[1][1] * c5 - this->_matrix[1][2] * c4 + this->_matrix[1][3] * c3) * det;
  matrix._matrix[0][1] = (-this->_matrix[0][1] * c5 + this->_matrix[0][2] * c4 - this->_matrix[0][3] * c3) * det;
  matrix._matrix[0][2] = (+this->_matrix[3][1] * s5 - this->_matrix[3][2] * s4 + this->_matrix[3][3] * s3) * det;
  matrix._matrix[0][3] = (-this->_matrix[2][1] * s5 + this->_matrix[2][2] * s4 - this->_matrix[2][3] * s3) * det;

  matrix._matrix[1][0] = (-this->_matrix[1][0] * c5 + this->_matrix[1][2] * c2 - this->_matrix[1][3] * c1) * det;
  matrix._matrix[1][1] = (+this->_matrix[0][0] * c5 - this->_matrix[0][2] * c2 + this->_matrix[0][3] * c1) * det;
  matrix._matrix[1][2] = (-this->_matrix[3][0] * s5 + this->_matrix[3][2] * s2 - this->_matrix[3][3] * s1) * det;
  matrix._matrix[1][3] = (+this->_matrix[2][0] * s5 - this->_matrix[2][2] * s2 + this->_matrix[2][3] * s1) * det;

  matrix._matrix[2][0] = (+this->_matrix[1][0] * c4 - this->_matrix[1][1] * c2 + this->_matrix[1][3] * c0) * det;
  matrix._matrix[2][1] = (-this->_matrix[0][0] * c4 + this->_matrix[0][1] * c2 - this->_matrix[0][3] * c0) * det;
  matrix._matrix[2][2] = (+this->_matrix[3][0] * s4 - this->_matrix[3][1] * s2 + this->_matrix[3][3] * s0) * det;
  matrix._matrix[2][3] = (-this->_matrix[2][0] * s4 + this->_matrix[2][1] * s2 - this->_matrix[2][3] * s0) * det;

  matrix._matrix[3][0] = (-this->_matrix[1][0] * c3 + this->_matrix[1][1] * c1 - this->_matrix[1][2] * c0) * det;
  matrix._matrix[3][1] = (+this->_matrix[0][0] * c3 - this->_matrix[0][1] * c1 + this->_matrix[0][2] * c0) * det;
  matrix._matrix[3][2] = (-this->_matrix[3][0] * s3 + this->_matrix[3][1] * s1 - this->_matrix[3][2] * s0) * det;
  matrix._matrix[3][3] = (+this->_matrix[2][0] * s3 - this->_matrix[2][1] * s1 + this->_matrix[2][2] * s0) * det;
